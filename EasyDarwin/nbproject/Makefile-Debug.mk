...
# C Compiler Flags
CFLAGS=-pipe -Wall -Wno-format-y2k
...
${OBJECTDIR}/APIModules/QTSSAdminModule/frozen.o: APIModules/QTSSAdminModule/frozen.c 
	${MKDIR} -p ${OBJECTDIR}/APIModules/QTSSAdminModule
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APIModules/QTSSAdminModule/frozen.o APIModules/QTSSAdminModule/frozen.c

${OBJECTDIR}/APIModules/QTSSAdminModule/mongoose.o: APIModules/QTSSAdminModule/mongoose.c 
	${MKDIR} -p ${OBJECTDIR}/APIModules/QTSSAdminModule
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APIModules/QTSSAdminModule/mongoose.o APIModules/QTSSAdminModule/mongoose.c
